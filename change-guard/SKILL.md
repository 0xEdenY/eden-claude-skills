---
name: change-guard
description: 变更守卫（影响分析→完整性检查→文档同步）。当用户说"改一下这个功能"、"重构"、"修 bug"、"改了 X 但 Y 好像也要改"、"检查一下文档"时触发。
---
...
**影响清单持久化：**
- 简单变更（1-3 文件）：留在对话中
- 复杂变更（4+ 文件或跨模块）：写入 `docs/impact-{描述}.md`，跨 session 可读
- 项目结束后批量清理 `docs/impact-*.md`

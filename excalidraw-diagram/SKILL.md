...
description: Create Excalidraw diagram JSON files that make visual arguments. Use when the user wants to visualize workflows, architectures, or concepts. 当用户说"画个架构图"、"画个流程图"、"画个依赖关系图"、"画个数据流图"、"可视化一下"、"画个图"时触发。
---
